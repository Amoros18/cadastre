...
class RegistreRattachementPDFController extends Controller
{
    ...
    function index(Request $request){
        ...
        return view('registres.rattachement')->with([
            'registre'=>$registre,
    ...
    function convert_registre_to_html($registre){
        ...
        foreach($registre as $enregistrement){
            ...
            <tr>
                ...
                <td style = "border: 1px solid; padding:6px;">'.$enregistrement->telephone.'</td>
                <td style = "border: 1px solid; padding:6px;">'.$enregistrement->geometre.'</td>
                <td style = "border: 1px solid; padding:6px;">'.$enregistrement->montant_rattachement.'</td>
                <td style = "border: 1px solid; padding:6px;">'.$enregistrement->date_rattachement.'</td>
                <td style = "border: 1px solid; padding:6px;">'.$enregistrement->observation_rattachement.'</td>
            </tr>
            ';
        }
        $output.= '</table>';
