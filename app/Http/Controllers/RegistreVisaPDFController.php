...
class RegistreVisaPDFController extends Controller
{
    ...
    function index(Request $request){
        ...
        return view('registres.visa')->with([
            'registre'=>$registre,
    ...
    function convert_registre_to_html($registre){
        $output = '
        <h3 align="center"> Registre de visa <h3>
        <table width = "100%" style = "border-collapse:collapse; border:0px;"
            ...
            <th style = "border: 1px solid; padding:6px;" width = 10% >Sexe</th>
            ...
            <th style = "border: 1px solid; padding:6px;" width = 10% >Numero Visa</th>
        ...
        foreach($registre as $enregistrement){
            ...
            <td style = "border: 1px solid; padding:6px;">'.$enregistrement->numero_visa.'</td>
