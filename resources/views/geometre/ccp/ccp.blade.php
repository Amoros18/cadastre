...
<div class="container-fluid card-body shadow">
    <form id="formulaire_ancien_dossier" enctype="multipart/form-data" method="POST">
        @csrf
                ...
                <label for="numero_ccp" class="control-label">Numero CCP:</label>
                ...
                <label for="superficie" class="control-label">Superficie:</label>
                    ...
                    @enderror
                <label for="date_ccp" class="control-label">Date CCP:</label>
            ...
            @if ($table->point)
                    ...
                    <label for="data" class="control-label">Inserer le fichier des coordonnees:</label>
