@extends('archivage/accueil')

@section('title', 'Archivage')
@section('content')
<!-- @include('search') -->
<h2  class="container-fluid d-flex ">ARCHIVER DOSSIER</h2>
...
<div class="container-fluid d-flex ">
    <nav aria-label="breadcrumb " class="first  d-md-flex" >
         <ol class="breadcrumb indigo lighten-6 first-1 shadow-lg mb-5  ">
            ...
            <li><a class="black-text active-2" href="{{route('liste.archivage-intro')}}"><span >Archivage</span></a><i class="fas fa-solid fa-chevron-right ml-md-3 ml-1"></i></li>
            <li ><a class="black-text active-2  " href="#">
                <span >ARCHIVER DOSSIER</span></a><i class="fas fa-solid fa-chevron-right ml-md-3 ml-1"></i> </li>
            <!-- <li class="breadcrumb-item  mr-0 pr-0"><a class="black-text active-1 active-2" href="#"><span >Bread shape</span></a> </li> -->
        </ol>
    </nav>
</div>
<div class="container-fluid">
    <div class="container-fluid card-header shadow" style="background: linear-gradient(to right, #004e92, #000428)">
        ...
        <table id="table" class="table table-hover table-responsible table-striped">
            ...
            <tbody>
                @foreach ($Listes as $Liste )
                    <tr class="table-row" data-href="{{route('create.archivage',['numero_dossier'=>$Liste->numero_dossier])}} ">
