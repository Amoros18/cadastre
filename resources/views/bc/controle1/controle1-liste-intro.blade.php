...
@section('content')
<!-- @include('search') -->
<h2  class="container-fluid d-flex ">CONTRÔLE 1</h2>
...
<div class="container-fluid d-flex ">
    <nav aria-label="breadcrumb " class="first  d-md-flex" >
         <ol class="breadcrumb indigo lighten-6 first-1 shadow-lg mb-5  ">
            ...
            <li><a class="black-text active-2" href="{{route('liste.controle1-intro')}}"><span >BC</span></a><i class="fas fa-solid fa-chevron-right ml-md-3 ml-1"></i></li>
            <li ><a class="black-text active-2  " href="#">
                <span >CONTRÔLE 1</span></a><i class="fas fa-solid fa-chevron-right ml-md-3 ml-1"></i> </li>
            <!-- <li class="breadcrumb-item  mr-0 pr-0"><a class="black-text active-1 active-2" href="#"><span >Bread shape</span></a> </li> -->
        </ol>
    </nav>
</div>
<div class="container-fluid">
    <div class="container-fluid card-header shadow" style="background: linear-gradient(to right, #FF6347, #b31217)">
            ...
            <tbody>
                @foreach ($Listes as $Liste )
                    <tr class="table-row" data-href=" @if ($modifier ==1)
                                {{route('edit.controle1',['table'=>json_decode(json_encode($Liste->id),true)])}}
                            @else
                                {{route('create.controle1',['table'=>json_decode(json_encode($Liste->id),true)])}}
                            @endif
                            ">
