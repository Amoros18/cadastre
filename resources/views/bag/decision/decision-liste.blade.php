...
<h2  class="container-fluid d-flex ">MODIFIER DECISION</h2>
<div class="container-fluid d-flex ">
    <nav aria-label="breadcrumb " class="first  d-md-flex" >
         <ol class="breadcrumb indigo lighten-6 first-1 shadow-lg mb-5  ">
            ...
            <li ><a class="black-text active-2  " href="#"><span >BAG\Modifier décision</span></a><i class="fas fa-solid fa-chevron-right ml-md-3 ml-1"></i> </li>
        ...
        <table id="table" class="table table-hover table-responsible table-striped">
            ...
            <tbody>
                @foreach ($Listes as $Liste )
                    <tr>
                        <td><a  href = "{{route('edit.decision',['table'=>json_decode(json_encode($Liste->id),true)])}} ">{{$Liste->numero_decision}}</a></td>
                        <td><a  href = "{{route('edit.decision',['table'=>json_decode(json_encode($Liste->id),true)])}} ">{{$Liste->date_decision}}</a></td>
