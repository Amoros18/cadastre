...
@section('content')
<h2  class="container-fluid d-flex ">INSERER DECISION</h2>
<div class="container-fluid d-flex ">
    <nav aria-label="breadcrumb " class="first  d-md-flex" >
         <ol class="breadcrumb indigo lighten-6 first-1 shadow-lg mb-5  ">
            ...
            <li ><a class="black-text active-2  " href="#"><span >INSERER DECISION</span></a><i class="fas fa-solid fa-chevron-right ml-md-3 ml-1"></i> </li>
