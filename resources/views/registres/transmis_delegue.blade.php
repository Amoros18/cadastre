...
<h2  class="container-fluid">TRANSMISSION DELEGUE</h2>
...
<div class="container-fluid">
    <nav aria-label="breadcrumb " class="first  d-md-flex" >
         <ol class="breadcrumb indigo lighten-6 first-1 shadow-lg mb-5  ">
            ...
            <li><a href="#">
                <span>Transmission Délégué</span>
            </a></li>
...
<div class="container-fluid m-0 card shadow">
    <!-- <h3 >Generer le registre de transmission delegue</h3> -->
   
        <div class="card-header d-flex me-0 m-0 justify-content-end">
