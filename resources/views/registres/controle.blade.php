...
<h2  class="container-fluid">REGISTRE CONTRÔLE</h2>
    ...
    <nav aria-label="breadcrumb " class="first  d-md-flex" >
         <ol class="breadcrumb indigo lighten-6 first-1 shadow-lg mb-5  ">
            ...
            <li ><a class="black-text active-2  " href="#">
                <span >BUREAU DE CONTROLE\Registre contrôle</span></a><i class="fas fa-solid fa-chevron-right ml-md-3 ml-1"></i> </li>
...
<div class="container card shadow">
        ...
        <div class="container-fluid m-3 d-flex me-0 justify-content-end">
            <a href="{{route('registre.controle_pdf',[
