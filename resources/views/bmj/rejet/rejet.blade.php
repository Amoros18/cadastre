    ...
    <form id="formulaire_ancien_dossier" enctype="multipart/form-data" method="POST">
        @csrf
            <div class="form-group">
                ...
                <input type="text" name="motif" placeholder="Entrez le motif du rejet" required class="form-control" value="{{old('motif',$rejet->motif)}}">
                @error("motif")
            ...
            <div class="row">
                ...
                <div class="col-md form-group">
                    <label for="numero_dossier" class="control-label" style="color: black;">Numero de dossier:</label>
                    <input type="text" name="numero_dossier" required readonly placeholder="Merci de renseigner le numero du dossier a l'avance" class="form-control" value="{{old('numero_dossier',$rejet->numero_dossier, '')}}">
                    @error("numero_dossier")
                        <span class="text-danger" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
