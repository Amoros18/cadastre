...
@section('title', 'Ajout du geometre')
@section('employer','Geometre')

@section('content')
<h2  class="container-fluid d-flex ">AJOUTER GEOMETRE</h2>
    ...
    <nav aria-label="breadcrumb " class="first  d-md-flex" >
         <ol class="breadcrumb indigo lighten-6 first-1 shadow-lg mb-5  ">
            ...
            <li ><a class="black-text active-2  " href="#">
                <span >AJOUTER COLLEGUE\Ajouter géomètre</span></a><i class="fas fa-solid fa-chevron-right ml-md-3 ml-1"></i> </li>
