...
Route::prefix('liste/')->middleware('auth')->name('liste.')->group(function(){
    ...
    Route::get('/rattachement-intro',[DossierController::class,'listRattachement'])->name('rattachement-intro');
    Route::post('/rattachement-intro',[DossierController::class,'listRattachement']);
    ...
    Route::get('/main-courante-intro',[DossierController::class,'listMainCourante'])->name('main-courante-intro');
    Route::post('/main-courante-intro',[DossierController::class,'listMainCourante']);
